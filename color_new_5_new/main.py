...
class GraphColoringApp:
    ...
    def _run_backtracking(self):
        ...
        self.last_algorithm_run = {
            ...
            'performance_history': self.performance_history  # إضافة تاريخ الأداء
        }
    ...
    def _create_report_image(self, file_path):
        ...
        # الرسم البياني 3: مخطط Fitness Evolution (للـ Cultural فقط)
        ...
        if (self.last_algorithm_run['algorithm'] == 'Cultural Algorithm' and 
            ...
            # رسم مخطط Fitness Evolution للـ Cultural Algorithm
            ...
            ax3.set_title('Fitness Evolution', color='white', fontweight='bold', fontsize=12)
        ...
        bars = ax4.bar(metrics, values, 
                      ...
                      alpha=0.7, width=0.6)
        ax4.set_title(f'{algorithm_name.upper()} Performance', 
                     color='white', fontweight='bold', fontsize=12)
        ax4.set_ylabel('Value', color='white', fontweight='bold')
        ax4.set_ylim(0, max(values) * 1.2 if max(values) > 0 else 1.2)
